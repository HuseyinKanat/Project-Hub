    ...
    return (
      <div className="flex items-center justify-center p-8">
        <div className="text-center">
          ...
          <p className="text-slate-600">Loading board settings...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto max-w-5xl p-6">
      ...
      {activeTab === "general" && (
        <div className="card space-y-4 p-6">
          ...
          <p className="text-sm text-slate-600">Basic board information and configuration</p>
        ...
        <div className="space-y-6">
          ...
          <div className="card p-6">
            ...
            {boardQuery.isLoading ? (
              <div className="py-8 text-center text-slate-500">Loading states...</div>
            ) : (
              <WorkflowStateList
                states={states}
          ...
          {/* Transition Graph */}
          <div className="card p-6">
            <h2 className="mb-2 text-lg font-semibold">Transition Graph</h2>
      ...
      {activeTab === "members" && (
        <div className="card p-6">
          <h2 className="mb-2 text-lg font-semibold">Board Members</h2>
          <p className="mb-4 text-sm text-slate-600">Manage board access and roles (coming soon)</p>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold">Add New State</h2>
              <button
                type="button"
                onClick={() => setShowAddStateModal(false)}
            ...
            <p className="text-sm text-slate-600">Create a new workflow state for this board.</p>
            ...
            <label className="block space-y-2">
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <code className="rounded bg-slate-100 px-2 py-1 text-sm">{newStateColor}</code>
              </div>
            </label>
