---
type: component
files: [backend/app/services/sonarqube.py, backend/app/api/boards.py, backend/app/api/scans.py, backend/app/db/models/core.py, frontend/src/components/sonarqube/SonarSetupSection.tsx, frontend/src/api/client.ts, frontend/src/types/api.ts, scripts/sonar-scan-board.sh, scripts/sonar-scan-watcher.sh]
last_touched_ticket: PH-239
